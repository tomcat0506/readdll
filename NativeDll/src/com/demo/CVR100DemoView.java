...
//                    progressBar.setValue(value);
    ...
    {          
          ...
          try 
          {
             ...
             n.setRetVal(Type.INT); // 鎸囧畾杩斿洖鍙傛暟鐨勭被鍨�             n.setParameter(0, Port);                   
             n.invoke(); // 璋冪敤鏂规硶
     ...
     private  int GetPeopleName() throws NativeException, IllegalAccessException 
    {
          ...
          try 
          {
             ...
             n.setRetVal(Type.INT); // 鎸囧畾杩斿洖鍙傛暟鐨勭被鍨�
...
// TODO add your handling code here:  
   ...
   try
   {
        ...
        this.jTextArea1.append("杩斿洖鍊硷細" + String.valueOf(ret));
        this.jTextArea1.append("\n");
   }
   catch(Exception ex)
   {
       this.jTextArea1.append("璋冪敤寮傚父锛�+ ex.getMessage());
        this.jTextArea1.append("\n");
   }
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
       ...
       try
       {
            ...
            if(ret == 1)
            {               
                this.jTextArea1.append("濮撳悕锛� + strTmp.trim());
                this.jTextArea1.append("\n");  
            }           
       }
       catch(Exception ex)
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        try
       {
            ...
            if(ret == 1)
            {               
                this.jTextArea1.append("鍦板潃锛� + strTmp.trim());
                this.jTextArea1.append("\n");  
            }           
       }
       catch(Exception ex)
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        ...
        try
       {
            ...
            if(ret == 1)
            {               
                this.jTextArea1.append("韬唤鍙风爜锛� + strTmp.trim());
                this.jTextArea1.append("\n");  
            }           
       }
       catch(Exception ex)
